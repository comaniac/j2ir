...
public class CppUnitTest {
	...
	@Test public void testSingleInteritahce() { doTest("framework/SingleInheritanceTest"); }
	...
	private void doTest(String testName) {
		...
		try {
			...
			if (args[0] == null) { // Make a jar file
				...
				System.err.println("javac -g -d " + prjOutputDir + " " + testPath + "/*.java");
				compileProc.waitFor();
